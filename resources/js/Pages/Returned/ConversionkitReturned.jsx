...
const closeModals = () => {
  ...
  actions: (() => {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Returned Conversionkit" />

            <div className="flex items-center justify-between mb-4">
                <h1 className="text-2xl font-bold">Returned Conversionkit</h1>
            </div>
            ...
            <DataTable
                ...
                routeName={route("conversionkit.returned.index")}
      ...
      <table className="min-w-full border border-gray-300  text-gray-600  text-lg">
        ...
        <tbody className="text-center">
          <tr>
            ...
            <td>{selectedRow.package_from}</td>
            <td>{selectedRow.package_to}</td>
            <td>{selectedRow.case_no}</td>
            <td>{selectedRow.machine}</td>
            <td>
              <span
      ...
      <table className="min-w-full border border-gray-300  text-gray-600  text-lg mt-6">
        ...
        <tbody className="text-center">
          <tr>
            ...
            <td colSpan="3">{selectedRow.remarks}</td>
          </tr>
        </tbody>
      </table>
      ...
      <table className="min-w-full border border-gray-300  text-gray-600  text-lg mt-6">
        ...
        <tbody className="text-center">
          <tr>
            ...
            <td colSpan="3">{selectedRow.accept_remarks}</td>
          </tr>
        </tbody>
      </table>
