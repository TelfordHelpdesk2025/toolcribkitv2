...
Route::post('/conversionkit/request/approve/{id}/{package_to}/{machine}/{case_no}/{location}', [ConversionKitRequestController::class, 'approve'])->name('conversionkit.request.approve');
...
Route::post(
    '/conversionkit/request/accept/{id}/{package_to}/{machine}/{case_no}/{location}',
    [ConversionkitBorrowedController::class, 'accept']
)->name('conversionkit.borrowed.accept');
